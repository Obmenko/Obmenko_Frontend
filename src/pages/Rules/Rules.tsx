    ...
    <Container className={clsx(classes.root, 'docs')} wrapperClassName={classes['root-wrapper']}>
        ...
        <ol>
          ...
          <li>
            <p>
              ...
              {' '}
              <a href={CONTACTS.siteUrl}>{CONTACTS.siteUrl}</a>
              /.
            </p>
          </li>
          <li>
      ...
      <section>
        ...
        <ol>
          ...
          <li>
            <p>5.16. В случае обнаружения подозрительной активности в процессе оформления Заявки Пользователем, Сервис, во избежание ущерба, вправе приостанавливать выполнение таких операций до выяснения причин такой активности.</p>
          </li>
          <li>
            <p>5.17. Сервис вправе отказать в выполнении обмена, если передача криптовалюты, электронных денег или фиатной валюты на счет Сервиса была произведена без оформления Заявки при помощи пользовательских интерфейсов на Сайте Сервиса. Криптовалюта, электронные деньги или фиатная валюта, перечисленные на счет Сервиса Пользователем без оформления Заявки при помощи пользовательских интерфейсов на Сайте Сервиса, могут быть возвращены Пользователю по запросу с учетом вычета комиссии платежной системы в соответствии с ограничениями, установленными настоящими Правилами.</p>
          </li>
          <li>
            <p>5.18. Сервис имеет право отказать в предоставлении услуг Пользователю в случае непредоставления Пользователем полных и достаточных данных, необходимых для его идентификации, и заблокировать Средства, полученные от Пользователя до момента сообщения им таких данных.</p>
          </li>
          <li>
            <p>5.19. Сервис оказывает услуги только по обмену криптовалюты на электронные деньги или фиатную валюту, либо наоборот. Сервис не производит валютные операции в отношении национальных денег и не подпадает под национальное и международное законодательство о валютном регулировании и валютном контроле.</p>
          </li>
          <li>
            <p>
              5.20. Сервис прилагает разумные усилия для обеспечения доступа к услугам и сайту
              {' '}
              {CONTACTS.name}
              {' '}
          ...
          <li>
            <p>5.21. Для проверки транзакций на предмет противодействия отмывания денежных средств обменный пункт использует сервис AMLbot. Более подробно с данным сервисом Вы можете ознакомиться по ссылке: amlbot.com</p>
          </li>
          <li>
            <p>5.22. Сервис имеет право аннулировать обмен при возникновении подозрений о получении Пользователем Средств в результате любой противоправной деятельности в соответствии с законодательством государства размещения Сервиса или государства, резидентом которого является Пользователь. Если средства поступили с сайтов, относящихся к противоправной деятельности( &lquot;Гидра&rquot;, &lquot;Даркнет&rquot;и прочее) — данные средства блокируются. При проведении AML проверки обменный пункт ориентируется на подробный анализ по конкретной транзакции. В случае если подробный анализ выявляет параметры высокого риска более или 90% -необходима полная верификация личности согласно п 8.2. Выплата по данным заявкам производится по заградительному тарифу согласно правил п.8.3.</p>
          </li>
          <li>
            <p>5.23. При проверке транзакций на предмет противодействия отмывания денежных средств обменный пункт ориентируется на параметры высокого риска. Параметрами высокого риска являются : &lquot;Dark Service&rquot;; &lquot;Dark Market&rquot;; &lquot;Exchange Fraudulent&rquot;; &lquot;Scam&rquot;; &lquot;Illegal Service&rquot;; &lquot;Stolen&rquot;; &lquot;Mixer&rquot;; &lquot;Ransom&rquot;; &lquot;Gambling&rquot;. Более подробно с описанием параметров высокого риска Вы можете ознакомиться по ссылке: amlbot.com/ru/chto-my-analiziruem/</p>
          </li>
          <li>
            <p>5.24. В ночное время заявки обрабатываются оператором в ручном режиме . В случае если в Вашей заявке допущена ошибка (или если Ваша заявка попала на проверку) она будет выплачена после проверки администратора в порядке очереди начиная с 9:00 . Так же в случае форс-мажорных обстоятельств заявка будет выплачена в порядке очереди начиная с 9:00.</p>
          </li>
          <li>
            <p>5.25. В случае возврата Средства, полученные от Пользователя в ночное время, могут быть возвращены в рабочее время обменного пункта в эквиваленте USDT на момент начала работы Сервиса.</p>
          </li>
          <li>
            <p>5.26. При работе с Заявками Пользователей, администрация Сервиса вправе:</p>
          </li>
          <li>
            <p>5.26.1. Прекратить общение с Пользователем, нарушающим этикет делового общения, задающим вопросы, не связанные с предоставлением Сервисом услуг или не предоставляющим Сервису необходимой для оказания услуг информации.</p>
          </li>
          <li>
            <p>5.26.2. При необходимости заблокировать проведение операции и Средства Пользователя до предоставления им полных и достаточных для идентификации его личности данных.</p>
          </li>
          <li>
            <p>5.26.3. Привлекать для исполнения своих обязательств сторонних исполнителей.</p>
          </li>
          <li>
            <p>5.26.4. Распоряжаться по собственному усмотрению любыми Средствами, поступившими на счет Сервиса без создания Заявки.</p>
          </li>
          <li>
            <p>5.26.5. Отправлять Пользователю на указанный им в Аккаунте e-mail информацию о состоянии процесса обмена, а также иную информацию, касающуюся деятельности Сервиса, в том числе рекламного характера. Отписаться от рекламных рассылок Пользователь может, нажав на соответствующую кнопку в полученном письме.</p>
          </li>
          <li>
            <p>5.27. Обменный пункт принимает транзакции только через стандартные блокчейны криптовалют. Мы не поддерживаем другие альтернативные блокчейны.</p>
          </li>
        </ol>
      </section>
      <section>
