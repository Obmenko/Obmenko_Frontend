  ...
  <Container className={clsx(classes.root, 'docs')} wrapperClassName={classes['root-wrapper']}>
    ...
    <section>
      ...
      <ol>
        ...
        <li>
          <p>
            5.15. Обменный сервис работает по правилам и нормам регулятора
            {' '}
            <a href="https://www.cysec.gov.cy">https://www.cysec.gov.cy</a>
          </p>
        </li>
        <li>
          <p>5.16. Возврат Средств в случае, предусмотренном п. 5.13 настоящих Правил, возможен при предоставлении Пользователем документов согласно требованию Сервиса.</p>
        </li>
        <li>
